...
const DICT = {
  ...
  en: {
    ...
    studentSortLabel: 'Sort:',
    studentSortByName: 'Name',
    studentSortByCreated: 'Date added',
    studentSortByActivity: 'Last activity',
    studentSortDirAscTooltip: 'Ascending — click for descending',
    studentSortDirDescTooltip: 'Descending — click for ascending',
  ...
  zh: {
    ...
    studentSortLabel: '排序：',
    studentSortByName: '名称',
    studentSortByCreated: '添加时间',
    studentSortByActivity: '最近活动',
    studentSortDirAscTooltip: '升序（点击切换为降序）',
    studentSortDirDescTooltip: '降序（点击切换为升序）',
  ...
  es: {
    ...
    studentSortLabel: 'Ordenar:',
    studentSortByName: 'Nombre',
    studentSortByCreated: 'Fecha de creación',
    studentSortByActivity: 'Última actividad',
    studentSortDirAscTooltip: 'Ascendente — clic para descendente',
    studentSortDirDescTooltip: 'Descendente — clic para ascendente',
  ...
  de: {
    ...
    studentSortLabel: 'Sortieren:',
    studentSortByName: 'Name',
    studentSortByCreated: 'Erstellungsdatum',
    studentSortByActivity: 'Letzte Aktivität',
    studentSortDirAscTooltip: 'Aufsteigend — Klick für absteigend',
    studentSortDirDescTooltip: 'Absteigend — Klick für aufsteigend',
  ...
  fr: {
    ...
    studentSortLabel: 'Trier :',
    studentSortByName: 'Nom',
    studentSortByCreated: 'Date de création',
    studentSortByActivity: 'Dernière activité',
    studentSortDirAscTooltip: 'Croissant — cliquer pour décroissant',
    studentSortDirDescTooltip: 'Décroissant — cliquer pour croissant',
  ...
  ja: {
    ...
    studentSortLabel: '並び替え：',
    studentSortByName: '名前',
    studentSortByCreated: '追加日',
    studentSortByActivity: '最終アクティビティ',
    studentSortDirAscTooltip: '昇順（クリックで降順に切り替え）',
    studentSortDirDescTooltip: '降順（クリックで昇順に切り替え）',
  ...
  ko: {
    ...
    studentSortLabel: '정렬:',
    studentSortByName: '이름',
    studentSortByCreated: '추가한 날짜',
    studentSortByActivity: '최근 활동',
    studentSortDirAscTooltip: '오름차순 — 클릭하면 내림차순',
    studentSortDirDescTooltip: '내림차순 — 클릭하면 오름차순',
  ...
  ru: {
    ...
    studentSortLabel: 'Сортировка:',
    studentSortByName: 'Имя',
    studentSortByCreated: 'Дата добавления',
    studentSortByActivity: 'Последняя активность',
    studentSortDirAscTooltip: 'По возрастанию — нажмите, чтобы по убыванию',
    studentSortDirDescTooltip: 'По убыванию — нажмите, чтобы по возрастанию',
  ...
  ar: {
    ...
    studentSortLabel: 'الترتيب:',
    studentSortByName: 'الاسم',
    studentSortByCreated: 'تاريخ الإضافة',
    studentSortByActivity: 'آخر نشاط',
    studentSortDirAscTooltip: 'تصاعدي — انقر للتبديل إلى تنازلي',
    studentSortDirDescTooltip: 'تنازلي — انقر للتبديل إلى تصاعدي',
